...
/* GPIO for SSI pins */
/* CLK pin */
#define SDC_SSI_CLK_SYSCTL_PERIPH    SYSCTL_PERIPH_GPIOF
#define SDC_SSI_CLK_GPIO_PORT_BASE   GPIO_PORTF_BASE
#define SDC_SSI_CLK             GPIO_PIN_3
/* TX pin */
#define SDC_SSI_TX_SYSCTL_PERIPH    SYSCTL_PERIPH_GPIOF
#define SDC_SSI_TX_GPIO_PORT_BASE   GPIO_PORTF_BASE
#define SDC_SSI_TX              GPIO_PIN_1
/* RX pin */
#define SDC_SSI_RX_SYSCTL_PERIPH    SYSCTL_PERIPH_GPIOF
#define SDC_SSI_RX_GPIO_PORT_BASE   GPIO_PORTF_BASE
#define SDC_SSI_RX              GPIO_PIN_0
/* CS pin */
#define SDC_SSI_FSS_SYSCTL_PERIPH    SYSCTL_PERIPH_GPIOF
#define SDC_SSI_FSS_GPIO_PORT_BASE   GPIO_PORTF_BASE
...
void power_on (void)
{
    ...
    MAP_SysCtlPeripheralEnable(SDC_SSI_CLK_SYSCTL_PERIPH);
    MAP_SysCtlPeripheralEnable(SDC_SSI_TX_SYSCTL_PERIPH);
    MAP_SysCtlPeripheralEnable(SDC_SSI_RX_SYSCTL_PERIPH);
    MAP_SysCtlPeripheralEnable(SDC_SSI_FSS_SYSCTL_PERIPH);
